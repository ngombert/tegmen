...
@pytest.mark.asyncio
@patch("agent_maestro.main.classify_intent", return_value="unknown")
...
@pytest.mark.asyncio
@patch("agent_maestro.main.classify_intent", return_value="chitchat")
...
@patch("agent_maestro.main.classify_intent", return_value="gourmet")
